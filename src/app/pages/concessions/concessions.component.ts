...
export class ConcessionsComponent {
  ...
  items: ConcessionItem[] = [
    { name: 'Large Popcorn', price: 8.00, description: 'Classic buttery goodness, big enough to share.', category: 'popcorn', image: '/assets/img/shoftv-poster-summer.jpg' },
    { name: 'Medium Popcorn', price: 6.00, description: 'Perfectly portioned for one hungry moviegoer.', category: 'popcorn', image: '/assets/img/shoftv-poster-jazz.jpg' },
    { name: 'Small Popcorn', price: 4.50, description: 'A quick snack to satisfy the craving.', category: 'popcorn', image: '/assets/img/shoftv-poster-desert.jpg' },
    { name: 'Caramel Corn', price: 7.50, description: 'Sweet and crunchy caramel-coated delight.', category: 'popcorn', image: '/assets/img/shoftv-poster-fight.jpg' },
    { name: 'Large Soda', price: 5.00, description: 'Choose from Coke, Sprite, or Fanta.', category: 'drinks', image: '/assets/img/shoftv-poster-rain.jpg' },
    { name: 'Medium Soda', price: 4.00, description: 'The perfect companion to your popcorn.', category: 'drinks', image: '/assets/img/shoftv-poster-summer.jpg' },
    { name: 'Water Bottle', price: 3.00, description: 'Pure spring water in a recyclable bottle.', category: 'drinks', image: '/assets/img/shoftv-poster-desert.jpg' },
    { name: 'Nachos', price: 6.50, description: 'Crunchy tortilla chips with warm cheese sauce.', category: 'snacks', image: '/assets/img/shoftv-poster-jazz.jpg' },
    { name: 'Candy Bar', price: 4.00, description: 'Choose from M&Ms, Snickers, or Reeses.', category: 'snacks', image: '/assets/img/shoftv-poster-rain.jpg' },
    { name: 'Movie Night Combo', price: 15.00, description: 'Large popcorn + 2 large sodas + candy.', category: 'combos', image: '/assets/img/shoftv-cinema.jpg' },
    { name: 'Date Night Combo', price: 22.00, description: '2 large popcorns + 2 drinks + nachos.', category: 'combos', image: '/assets/img/shoftv-hero.jpg' },
  ];
  ...
  cartItems = signal<CartItem[]>([
    { item: { name: 'Large Popcorn', price: 8.00, description: '', category: 'popcorn', image: '/assets/img/shoftv-poster-summer.jpg' }, qty: 1 },
    { item: { name: 'Large Soda', price: 5.00, description: '', category: 'drinks', image: '/assets/img/shoftv-poster-rain.jpg' }, qty: 1 },
  ]);
