      ...
      <section class="grid min-h-screen place-items-center px-5 py-24">
        <div class="w-full max-w-6xl">
          <div class="relative aspect-video overflow-hidden rounded-2xl border border-white/10 bg-card shadow-2xl">
           ...
           <div class="mt-5 flex items-center gap-4 rounded-2xl border border-white/10 bg-white/[0.03] p-4"><img src="/assets/img/pages/watch/watch.jpg" alt="" class="h-16 w-24 rounded-xl object-cover" /><div><p class="eyebrow">The ShofTV experience</p><p class="mt-1 text-sm text-secondary-foreground">Settle in, press play, and keep your story moving across every screen.</p></div></div>
