...
@Component({
  ...
  template: `
    <section class="relative isolate min-h-[720px] overflow-hidden lg:min-h-[800px]">
      <img src="/generated_images/shoftv-hero.jpg" alt="A cinematic theatre audience watching a film" class="absolute inset-0 h-full w-full object-cover object-[58%_center]" />
